...
<div id="toolbar">
    <a href="#" class="easyui-linkbutton add" onclick="create()" plain="true">新增</a>
    <a href="#" class="easyui-linkbutton edit" onclick="edit()" plain="true">修改</a>
    <a href="#" class="easyui-linkbutton remove" onclick="del()" plain="true">删除</a>
    <a href="#" class="easyui-linkbutton save" onclick="upload()" plain="true">excel导入</a>
    <a href="#" class="easyui-linkbutton back" onclick="exportExcel()" plain="true">excel导出</a>
    <div>
        ...
        <a href="#" class="easyui-linkbutton" onclick="doReset()">重置</a>

    </div>
</div>

<div id="dlg" class="easyui-dialog" title="数据参数" data-options="modal:true"
     style="width: 450px; height: 400px; top: 100px" closed="true" buttons="#dlg-buttons">
        ...
        <table cellpadding="5">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input class="easyui-textbox" readonly="readonly" required="true" type="text" name="name"
                           id="name"></input>
                    <a href="#" class="easyui-linkbutton" onclick="openWin('studentdg','学生信息');">选择</a>
                    <a href="#" class="easyui-linkbutton"
                       onclick="clearText('studentid','studentname');">清空</a>
                </td>
            </tr>
            <tr>
                <td>课程名称:</td>
                <td><input class="easyui-textbox" id="coursename" type="text" name="coursename" maxlength="10"
                           required="true" missingMessage="课程名称必须填写"></input></td>
            </tr>
            <tr>
                <td>分数:</td>
                <td><input class="easyui-textbox" id="score" type="text" name="score" maxlength="10"
                           validtype="intOrFloat" required="true" missingMessage="成绩必须填写"></input></td>
            </tr>
            <tr>
                <td>学期:</td>
                <td><input class="easyui-textbox" id="term" type="text" name="term" maxlength="10" required="true"
                           missingMessage="学期名称必须填写"></input></td>
            </tr>
            <tr>
                <td>班级:</td>
                <td><input class="easyui-textbox" id="classname" type="text" name="classname" maxlength="10"
                           required="true" missingMessage="班级必须填写"></input></td>
            </tr>
            <tr>
                <td>教师:</td>
                <td>
                    <input type="hidden" name="teacherid" id="teacherid"></input>
                    <input class="easyui-textbox" readonly="readonly" required="true" type="text" name="teachername"
                           id="teachername"></input>
                    <a href="#" class="easyui-linkbutton"
                       onclick="openTeacherWin('teacherdg','教师信息');">选择</a>
                    <a href="#" class="easyui-linkbutton"
                       onclick="clearText('teacherid','teachername');">清空</a>
                </td>
            </tr>
        </table>
    </form>
...
<div id="dlg-buttons">
    <a href="#" class="easyui-linkbutton  save" onclick="save()">保存</a>
    <a href="#" class="easyui-linkbutton cancel" onclick="javascript:$('#dlg').dialog('close')"
       >取消</a>
</div>

<div id="teacherdg" class="easyui-dialog" title="数据" style="width: 350px; height: 450px; top: 80px;"
...
<div id="teachertoolbar">
    <div>
        教师姓名: <input class="easyui-textbox" id="paramTeacherName">
        <br/>
        <a href="#" class="easyui-linkbutton" onclick="teacherSearch()">查找</a>
        <a href="#" class="easyui-linkbutton" onclick="teacherReset()">重置</a>
    </div>
</div>
<div id="dlgTeacher-buttons">
    <a href="#" class="easyui-linkbutton  save"
       onclick="afterTeacherSelect('teachertable','teacherdg','teacherid','teachername')">确定</a>
    <a href="#" class="easyui-linkbutton cancel" onclick="javascript:$('#teacherdg').dialog('close')"
       >取消</a>
</div>

<div id="studentdg" class="easyui-dialog" title="数据" style="width: 350px; height: 450px; top: 80px;"
     data-options="modal:true" closed="true" buttons="#dlgClass-buttons">
...
<div id="studenttoolbar">
    <div>
        ...
        <br/>
        <a href="#" class="easyui-linkbutton" onclick="studentSearch()">查找</a>
        <a href="#" class="easyui-linkbutton" onclick="studentReset()">重置</a>
    </div>
</div>
<div id="dlgClass-buttons">
    <a href="#" class="easyui-linkbutton  save" onclick="afterSelect('studenttable','studentdg','studentid','name')"
       >确定</a>
    <a href="#" class="easyui-linkbutton cancel" onclick="javascript:$('#studentdg').dialog('close')"
       >取消</a>
</div>

<div id="dlg-upload" class="easyui-dialog" title="excel导入" data-options="modal:true"
     style="width: 350px; height: 130px; top: 80px;" closed="true" buttons="#upload-buttons">
    <form method="post" id="fm-upload" enctype="multipart/form-data">
        <table>
            <tr>
                <td>上传excel:</td>
                <td><input class="easyui-filebox" style="width:240px" accept="application/vnd.ms-excel" id="scoreExcel"
                           name="scoreExcel" data-options="prompt:'请选择文件...'"></input></td>
            </tr>
        </table>
    </form>
</div>
...
<div id="upload-buttons">
    <a href="#" class="easyui-linkbutton  save" onclick="uploadExcel()">上传</a>
    <a href="#" class="easyui-linkbutton cancel" onclick="javascript:$('#dlg-upload').dialog('close')"
       >取消</a>
</div>
<script type="text/javascript">
    ...
    function doSearch() {
        var queryCondition = {
            'name': $('#paramName').val(),
            'teachername': $('#paramTeachername').val(),
            'coursename': $('#paramCourse').val(),
            'term': $('#paramTerm').val()
        };
