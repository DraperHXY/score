...
<div id="toolbar">
    ...
    <div>
        ...
        <a href="#" class="easyui-linkbutton" onclick="studentReset()">清空</a>
    </div>
</div>


<div id="dlg" class="easyui-dialog" title="数据参数" data-options="modal:true" style="width: 480px; height: 430px;"
    ...
    <form method="post" id="fm">
        <table cellpadding="5">
            ...
            <tr>
                <td>学号:</td>
                <td><input class="easyui-textbox" id="studentnum" type="text" name="studentnum" validtype="checkNum"
                           maxlength="15" required="true" missingMessage="学号必须填写"></input></td>
            </tr>
            <tr>
                <td>学生姓名:</td>
                <td><input class="easyui-textbox" id="name" type="text" name="name" maxlength="10" required="true"
            ...
            <tr>
                <td>出生日期:</td>
                <td><input class="easyui-datebox" id="birthday" editable="false" maxlength="20" type="text"
                           name="birthday"></input></td>
            </tr>
            <tr>
                <td>qq:</td>
                <td><input class="easyui-textbox" id="qq" validtype="qq" maxlength="15" type="text" name="qq"></input>
                </td>
            </tr>
            <tr>
                <td>电话:</td>
...
<div id="dlg-update" class="easyui-dialog" title="数据参数" data-options="modal:true" style="width: 480px; height: 430px;"
    ...
    <form method="post" id="fm-update">
        <table cellpadding="5">
            ...
            <tr>
                <td>学号:</td>
                <td><input class="easyui-textbox" id="studentnum" type="text" name="studentnum" readonly="readonly"
...
<div id="update-buttons">
    <a href="#" class="easyui-linkbutton  save" onclick="update()">保存</a>
    <a href="#" class="easyui-linkbutton cancel" onclick="javascript:$('#dlg-update').dialog('close')"
       >取消</a>
</div>
...
<script type="text/javascript">
    ...
    function studentSearch() {
        var queryCondition = {
            'studentnum': $('#paramStudentnum').val(),
            'name': $('#paramStudent').val(),
            'mobile': $('#paramMobile').val(),
            'qq': $('#paramQq').val(),
            'dormName': $('#paramDormName').val()
        };
